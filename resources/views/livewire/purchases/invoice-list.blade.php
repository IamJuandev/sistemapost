...
<div class="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-slate-800 dark:text-slate-100">Facturas de Proveedores</h1>
            <p class="mt-1 text-slate-500 dark:text-slate-300">Consulta y gestiona el estado de las facturas entrantes.
            </p>
        </div>
    </div>
        ...
        <div class="p-4 border-b border-slate-200 dark:border-slate-700 flex flex-col md:flex-row gap-4">
            <div class="relative flex-grow">
                ...
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="h-5 w-5 text-slate-400 dark:text-slate-500" xmlns="http://www.w.org/2000/svg"
                ...
                <tbody class="bg-white dark:bg-slate-800 divide-y divide-slate-200 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-slate-500 dark:text-slate-400">{{ $invoice->supplier->company_name
                                ?? 'N/A' }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-slate-600 dark:text-slate-300">Ingreso: {{
                        ...
                        <td
                            ...
                            ${{ number_format($invoice->total_with_tax ?? 0, 2) }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div x-data="{ open: false }" @click.away="open = false" class="inline-block text-left">
                                    ...
                                    <div x-show="open" x-transition
                                        ...
                                        <div class="py-1" role="menu" aria-orientation="vertical">
                                            ...
                                            <button wire:click="markAsProcessed({{ $invoice->id }})"
                                                class="flex items-center w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700"
                                                role="menuitem">
                        ...
                        <td colspan="5">
                            <div class="text-center py-12">
                                ...
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Prueba con un filtro
                                    diferente o crea una nueva compra.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
